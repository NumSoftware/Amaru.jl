...
LineSeries_params = [
    ...
    KwArgInfo((:ls, :linestyle), "Edge style", :solid, values=_line_style_list),
    KwArgInfo(:dash, "Dash pattern", Float64[]),
    KwArgInfo((:linecolor, :lc, :color), "Edge linecolor", :default),
    KwArgInfo((:lw, :lineweight), "Edge weight", 0.5, cond=:(lw>0)),
