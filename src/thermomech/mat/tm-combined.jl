...
ip_state_type(::Type{TMCombined{M1,M2}}) where {M1,M2} = TMCombinedState{ip_state_type(M1), ip_state_type(M2)} 

matching_elem_types(::Type{TMCombined{M1,M2}}) where {M1,M2} = (TMSolid, TMShell)
