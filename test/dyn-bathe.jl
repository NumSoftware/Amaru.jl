...
materials = [
    MaterialBind(10, DruckerPrager(E=Ec, nu=0.2, rho=roc, alpha=0.4312, kappa=3771.2) ),
    #MaterialBind(10, ElasticSolid(E=Ec, rho=roc) ),
...
P = (((-13.5)/0.00022480894387096)/1000)
bcs = [
BC(:node, :(y==0  && z==3*0.0254), :( uz = 0, uy=0, ux=0 )),
BC(:node, :(y==136*0.0254  && z==3*0.0254), :(uz=0 )),
BC(:node, :(x==0 && z==11*0.0254 && y==50*0.0254), fz=:( (((-13.5)/0.00022480894387096)/1000)/4) ),
BC(:node, :(x==6*0.0254 && z==11*0.0254 && y==50*0.0254), fz=:( (((-13.5)/0.00022480894387096)/1000)/4) ),
BC(:node, :(x==0 && z==11*0.0254 && y==86*0.0254), fz=:( (((-13.5)/0.00022480894387096)/1000)/4) ),
BC(:node, :(x==6*0.0254 && z==11*0.0254 && y==86*0.0254), fz=:( (((-13.5)/0.00022480894387096)/1000)/4) ),
