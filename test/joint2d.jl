...
mats = [
    ...
    MaterialBind(:joints, MCJoint(E=E, nu=0.2, ft=2.4e3, mu=1.4, alpha=1.0, wc=1.7e-4, ws=1.85e-5 ) ),
...
@test solve!(dom, bcs, auto_inc=true, nincs=20, maxits=3, tol=0.01, verbose=true, scheme=:ME, nouts=10)
