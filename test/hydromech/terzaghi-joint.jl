...
for i=1:2
    materials = [
        ...
        "joints" => ElasticJointSeep(E=E, nu=nu, zeta=100, k=k, gammaw=gw, alpha=alpha, S=S, beta=1/Kw, eta=eta, kt=1),
        "joints" => MCJointSeep(E=E, nu=nu, ft=2.4e3, mu=1.4, zeta=100, wc=1.7e-4, ws=1.85e-5, softcurve="hordijk", k=k, gammaw=gw, alpha=alpha, S=S, beta=1/Kw, eta=eta, kt=1),
    ]
