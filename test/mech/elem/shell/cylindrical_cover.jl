...
bl1 = Block( [-300 0 0; -300 600 0; -300 300 0], n=30, cellshape=LIN3, tag="shell")

msh = Mesh(bl1, printlog=true)
msh = revolve(msh, angle=180, n=60)

# Finite element model

mats = [ "shell" => ElasticShellQUAD4(E=300, nu=0.3, thickness=3) ]

dom = Domain(msh, mats)
Amaru.setquadrature!(dom.elems, 9)
