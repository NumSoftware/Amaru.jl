...
mesh=Mesh(bl1,bl2,bl3,bl4,bl5,bl6,bl7,bl8,bl9,bl10,bl11,bl12,bl13,bl14,bl15,bl16,bl17,bl18,bl19,bl20,bl21,verbosity=1)
...
dynsolve!(dom, bcs, time_span=33.0, sism=true, tds=30.9, tss=0.0, nincs=50, verbosity=1, filekey="dyn", nouts=10, autoinc=true, alpha=0.0, beta=0.0)
